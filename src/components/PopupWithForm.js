...
const PopupWithForm = ({ name, title, isOpen, container, onClose, children, handleSubmit}) => {
  return(
    <div className={isOpen ? `popup popup_type_${name} popup_status_opened` : `popup popup_type_${name}`}>
