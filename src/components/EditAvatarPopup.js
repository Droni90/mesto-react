...
const EditAvatarPopup = ({isOpen, onClose, onUpdateAvatar, hidePopupByClickAround, waiting}) => {
  ...
  return(
    <PopupWithForm name='refresh' title='Обновить аватар' waiting={waiting} hidePopupByClickAround={hidePopupByClickAround} handleSubmit={handleSubmit} isOpen={isOpen} container='popup__container popup__container_size_mini' onClose={onClose} >
